...
class TestCLIExecutionsV2(base.BaseCommandTest):
    ...
    def test_create_wf_input_file(self, mock):
        mock.return_value = EXECUTION
        path = pkg.resource_filename('highlanderclient',
    ...
    @mock.patch('highlanderclient.api.v2.executions.ExecutionManager.update')
    ...
    @mock.patch('highlanderclient.api.v2.executions.ExecutionManager.list')
    ...
    @mock.patch('highlanderclient.api.v2.executions.ExecutionManager.get')
    ...
    @mock.patch('highlanderclient.api.v2.executions.ExecutionManager.delete')
