...
from highlanderclient.api.v2 import tasks
from highlanderclient.commands.v2 import tasks as task_cmd
...
class TestCLITasksV2(base.BaseCommandTest):
    @mock.patch('highlanderclient.api.v2.tasks.TaskManager.list')
    ...
    @mock.patch('highlanderclient.api.v2.tasks.TaskManager.get')
