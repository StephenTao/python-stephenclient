...
from highlanderclient.api.v2 import workbooks
from highlanderclient.commands.v2 import workbooks as workbook_cmd
...
class TestCLIWorkbooksV2(base.BaseCommandTest):
    ...
    @mock.patch('highlanderclient.api.v2.workbooks.WorkbookManager.create')
    ...
    @mock.patch('argparse.open', create=True)
    @mock.patch('highlanderclient.api.v2.workbooks.WorkbookManager.update')
    ...
    @mock.patch('highlanderclient.api.v2.workbooks.WorkbookManager.list')
    ...
    @mock.patch('highlanderclient.api.v2.workbooks.WorkbookManager.get')
    ...
    @mock.patch('highlanderclient.api.v2.workbooks.WorkbookManager.delete')
    ...
    @mock.patch('argparse.open', create=True)
    @mock.patch('highlanderclient.api.v2.workbooks.WorkbookManager.validate')
