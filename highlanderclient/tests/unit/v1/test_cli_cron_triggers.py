...
from highlanderclient.api.v2 import cron_triggers
from highlanderclient.commands.v2 import cron_triggers as cron_triggers_cmd
...
class TestCLITriggersV2(base.BaseCommandTest):
    ...
    @mock.patch('highlanderclient.api.v2.cron_triggers.CronTriggerManager.create')
    ...
    @mock.patch('highlanderclient.api.v2.cron_triggers.CronTriggerManager.list')
    ...
    @mock.patch('highlanderclient.api.v2.cron_triggers.CronTriggerManager.get')
    ...
    @mock.patch('highlanderclient.api.v2.cron_triggers.CronTriggerManager.delete')
