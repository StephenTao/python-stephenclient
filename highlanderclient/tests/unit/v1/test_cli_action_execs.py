...
from highlanderclient.api.v2 import action_executions as action_ex
from highlanderclient.commands.v2 import action_executions as action_ex_cmd
...
class TestCLIActionExecutions(base.BaseCommandTest):
    @mock.patch(
        'highlanderclient.api.v2.action_executions.ActionExecutionManager.update'
    )
    ...
    @mock.patch(
        'highlanderclient.api.v2.action_executions.ActionExecutionManager.list'
    )
    ...
    @mock.patch(
        'highlanderclient.api.v2.action_executions.ActionExecutionManager.get'
    )
